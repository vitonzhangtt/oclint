...
class ObjCVerifyPropertyIsNotAssignForReferenceTypeRule : public AbstractASTVisitorRule<ObjCVerifyPropertyIsNotAssignForReferenceTypeRule>
{
public:
    virtual const string name() const override
    {
        return "obj c verify property is not assign for reference type";
    }
...
static RuleSet rules(new ObjCVerifyPropertyIsNotAssignForReferenceTypeRule());
